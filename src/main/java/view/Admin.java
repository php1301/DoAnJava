...
public class Admin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/icons8_minus_32px.png"))); // NOI18N
        ...
        jLabel6.setText("Refresh trang Admin");

        jLabel4.setForeground(new java.awt.Color(204, 204, 204));
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/icons8_target_40px.png"))); // NOI18N

        jLabel5.setForeground(new java.awt.Color(204, 204, 204));
        jLabel5.setText("Button 2 ");

        jLabel36.setForeground(new java.awt.Color(204, 204, 204));
        jLabel36.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/icons8_target_40px.png"))); // NOI18N

        jLabel37.setForeground(new java.awt.Color(204, 204, 204));
        jLabel37.setText("Button 3");

        jLabel47.setForeground(new java.awt.Color(204, 204, 204));
        jLabel47.setText("Báo cáo doanh thu");
        ...
        panelUsers.setBackground(new java.awt.Color(44, 52, 58));
        panelUsers.setPreferredSize(new java.awt.Dimension(250, 400));
        ...
        jLabel25.setText("Xem sơ đồ ghế cho lịch đó");
        ...
        jLabel8.setText("Chào mừng đã đến với trang admin Max Cinema");
        ...
        jLabel48.setBackground(new java.awt.Color(54, 81, 207));
        jLabel48.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel48.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/icons8_cinema_96px.png"))); // NOI18N
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        int result = JOptionPane.showConfirmDialog(Admin.this, "Bạn có chắc chắc muốn đăng xuất trang Admin không?", "Đăng xuất trang Admin",
                JOptionPane.YES_NO_OPTION);
        if (result == JOptionPane.YES_OPTION) {
            try {
                prefs.clear();
                JOptionPane.showMessageDialog(Admin.this, "Đăng xuất thành công", "Thành công",
                        JOptionPane.INFORMATION_MESSAGE);
                login.main(null);
                dispose();
            } catch (BackingStoreException ex) {
                Logger.getLogger(Admin.class.getName()).log(Level.SEVERE, null, ex);
                JOptionPane.showMessageDialog(Admin.this, "Đăng xuất thất bại", "Thất bại",
    ...
    private void panelUsersMouseClicked(java.awt.event.MouseEvent evt) {                                        
        // TODO add your handling code here:
        QLKH.main(null);
    }                                       
    ...
    private void showAnh(String name) throws MalformedURLException {
        try {
            ...
            Image newImg = img.getScaledInstance(jLabel49.getWidth(), jLabel49.getHeight(), Image.SCALE_SMOOTH);
            ImageIcon image = new ImageIcon(newImg);
            jLabel49.setIcon(image);
    ...
    private void setThongTinNguoiDung() {
        try {
            jTextField1.setText("Chào mừng admin: " + username);
            showAnh(avatar);
