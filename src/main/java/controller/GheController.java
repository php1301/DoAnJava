...
//    public List<Ghe> layDanhSachGheCuaRap(int maRapArg) throws SQLException {
//        System.out.println("Lay danh sach ghe cua rap");
//        listGhe.clear();
...
//    }
    ...
    public ArrayList<Integer> layGheDaDat(int maLichChieu) throws SQLException {
        System.out.println("Lay danh sach ghe da dat");
        listGhe.clear();
        String sql = "select maGhe from GheDaDat where maLichChieu = ?";
        PreparedStatement ps = null;
        ResultSet rs = null;
        ArrayList<Integer> gheDaDat = new ArrayList<>();
        try {
            connect();
            ps = con.prepareStatement(sql);
