 ...
 */
public class ComboBoxHelper implements PopupMenuListener
{
	 ...
	 */
	public ComboBoxHelper(boolean popupWider, boolean popupAbove)
	{
	 ...
	 */
	public ComboBoxHelper(int maximumWidth)
	{
